...
<head>
    ...
    <title>${code?if_exists} Error Page</title>
        ...
        <div class="main-content ">
            ...
            <div class="infos">
                <div class="infos-main">
                    <div class="infos-h1"><h1>${code?if_exists}</h1></div>
                    <div class="infos-h2">${message?if_exists}</div>
                    <div class="infos-h2">
            ...
            <div class="footer">
                ...
                <a href="${options.blog_title}">${options.blog_title?default('SENS')}</a>
