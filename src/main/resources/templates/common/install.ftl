...
<html lang="zh">
    <head>
        ...
        <title>SENS-<@spring.message code='install.page.title'/></title>
        ...
        <link rel="stylesheet" href="${options.blog_static_url?if_exists}/static/plugins/bootstrapvalidator/css/bootstrapValidator.min.css">
        <!--[if lt IE 9]>
            ...
            <div class="row" style="padding-top: 50px">
                <div class="col-lg-12 col-xs-12">
                    <div class="logo animated fadeInUp">
                        SENS <small style="font-size: 14px;"><@spring.message code='install.page.title'/></small>
                    </div>
                    <#if isInstall==false>
   ...
   `;''+@@@#@:`    #'                                          .@``    ` ;@@#.
    ...
    <script src="${options.blog_static_url?if_exists}/static/plugins/bootstrapvalidator/js/bootstrapValidator.min.js"></script>
    <script src="${options.blog_static_url?if_exists}/static/plugins/bootstrapvalidator/js/language/zh_CN.js"></script>
    <#if isInstall==false>
    <script>
