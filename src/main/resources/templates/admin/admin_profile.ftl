                                ...
                                <div class="tab-pane active" id="general">
                                    <form method="post" class="form-horizontal" id="profileForm">
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                <label for="userEmail"
                                                       class="col-lg-2 col-sm-4 control-label">每日单词计划数量</label>
                                                <div class="col-lg-4 col-sm-8">
                                                    <input type="number" class="form-control" id="planCount" name="planCount"
                                                           value="${user.planCount?if_exists}">
                                                </div>
                                            </div>
                                        </div>
