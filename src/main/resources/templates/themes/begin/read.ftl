                                                                        ...
                                                                        <div id="answer" class="">
                                                                            <table style="margin:100px auto">
                                                                                <tr>
                                                                                    <td>
                                                                                        <div class="row test-answers">
                                                                                            <a class="known record-btn"
                                                                                               data-id="${word.id?if_exists}"
                                                                                               data-status="1"
                                                                                               href="javascript:void(0)">A.认识
                                                                                            </a>
                                                                                        </div>
                                                                                    </td>
                                                                                </tr>
                                                                                ...
                                                                                <tr>
                                                                                    <td>
                                                                                        <div class="row test-answers">
                                                                                            <a class="unknown record-btn"
                                                                                               data-id="${word.id?if_exists}"
                                                                                               data-status="0"
                                                                                               href="javascript:void(0)">B.不认识
                                                                                            </a>
                                                                                        </div>
                                                                                    </td>
                                                                                </tr>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="progress">
                                                                            <div class="progress-bar progress-bar-primary progress-bar-striped"
                                                                                 ...
                                                                                 style="width: ${(readCount/planToday*100)?default(100)}%">
                                                                                <span class="sr-only">${readCount?if_exists}/${planToday?if_exists}</span>
                                                                            </div>
                                                                            <p style="text-align: center;">${readCount?if_exists}
                                                                                /${planToday?if_exists}</p>
            ...
            $(document).on("click", ".record-btn", function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.code == 1) {
                            window.location.href = "/bei/detail?id=" + wordId;
                        }
                    }
                });
                return false;
